                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if(order.orderDetails[index].variations != null && order.orderDetails[index].variations.length > 0) {
                          ...
                          List<String> _variationTypes = order.orderDetails[index].oldVariations[0].type.split('-');
                          if(_variationTypes.length == order.orderDetails[index].productDetails.choiceOptions.length) {
                            int _index = 0;
                            order.orderDetails[index].productDetails.choiceOptions.forEach((choice) {
